...
export default function TwoDisposition(props: Props) {
    ...
    const imageOneContainerClass =
        "w-[60%] overflow-hidden group relative right-[-50px] h-fit max-w-fit";
    const imageTwoContainerClass =
        "mt-[150px] z-10 relative overflow-hidden group h-fit max-w-fit";
            ...
            <div class="lg:max-w-[35vw] w-full">
                <div className="w-[80%] lg:w-[70%] mx-auto lg:mx-0">
                    ...
                    {subtitle
                        ...
                        : null}
                    <p class="text-sm font-light tracking-[1px] leading-[25px] text-black mx-0 my-2.5 whitespace-pre-line">
                        {description}
                    </p>
