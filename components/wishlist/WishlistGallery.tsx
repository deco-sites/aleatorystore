import SearchResult, { Props as SearchResultProps, } from "../../components/search/SearchResult.tsx";
import WishlistMessageLogin from "../../islands/WishlistMessageLogin.tsx";
import { type AppContext, type SectionProps } from "@deco/deco";
export type Props = SearchResultProps;
export const loader = async (props: Props, req: Request, ctx: AppContext<any>) => {
...
function WishlistGallery(props: SectionProps<typeof loader>) {
    ...
    return !isEmpty
        ? (<SearchResult {...props} categoryBanners={undefined} device={props.device}/>)
