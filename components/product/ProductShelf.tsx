...
function ProductShelf(
  { products, title, description, layout, url }: SectionProps<typeof loader>,
) {
  const id = useId();
  ...
  return (
    <div
      class={clx(
        "container w-full pt-8 flex flex-col gap-6 lg:pt-10",
        isProductPage ? "lg:px-10 2xl:pl-20" : "",
        layout?.showArrows ? "lg:pb-[69px]" : "pb-8 lg:pb-10",
      )}
    >
