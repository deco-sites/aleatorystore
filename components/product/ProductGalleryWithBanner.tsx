...
function ProductGalleryWithBanner({ products, pageInfo, layout, offset, url, categoryBanners, device, }: Props) {
    ...
    return (<div class={`${!categoryBanners &&
      ...
      {products && products.length > 0 && device === "desktop"
            ? (<ProductCardWithBannerDesktop products={products} desktopColumns={desktop} mobileColumns={mobile} offset={offset} platform={platform} categoryBanners={categoryBanners}/>)
            : products && products.length > 0 && (<ProductCardWithBannerMobile products={products} desktopColumns={desktop} mobileColumns={mobile} offset={offset} platform={platform} categoryBanners={categoryBanners}/>)}
