...
function Header({ alerts, lightThemeBar = false, searchbar, navItems = [
    {
    ...
    height: 16,
    alt: "Logo",
}, logoPosition = "center", buttons, device, itemsPerColumn, }: SectionProps<typeof loader>) {
        ...
        <HeaderScroll>
          <Drawers menu={{ items }} searchbar={searchbar} platform={platform}>
            <div class="bg-secondary-neutral-100 fixed w-full z-40">
              ...
              <Navbar device={device} items={items} searchbar={searchbar && { ...searchbar, platform }} logo={logo} logoPosition={logoPosition} buttons={buttons} itemsPerColumn={itemsPerColumn}/>
            </div>
          </Drawers>
        </HeaderScroll>
      </header>)
