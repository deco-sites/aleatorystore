...
function Topic(props: TopicProps) {
    return (<div class="my-8 md:m-10 font-light institutional">
...
function Institutional({ institutionalTitle, topics, url }: SectionProps<typeof loader>) {
    const pathname = url.pathname;
    return (<main class="p-4 lg:px-8 max-w-[1700px] m-auto">
      <Breadcrumb itemListElement={[{ name: institutionalTitle, item: pathname }]}/>
